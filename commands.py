...
INVALID_DATE_MSG= 'Oh, we are expecting the date in format YYYY-MM-DD. You dropped the ball.'
DATE_IN_THE_FUTURE='That date is in the future man. Facu is the wizard but we are not.'
